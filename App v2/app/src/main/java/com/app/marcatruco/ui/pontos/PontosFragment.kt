package com.app.marcatruco.ui.pontos
...
import com.app.marcatruco.R
import com.app.marcatruco.databinding.FragmentPontosBinding
import com.app.marcatruco.ui.classes.SharedViewModel
import com.app.marcatruco.ui.historico.HistoricoFragment
import com.app.marcatruco.ui.historico.HistoricoViewModel
    ...
    fun edita_nome_time(time: TextView){
        ...
        confirma.setOnClickListener {
            ...
            if(time.id == R.id.txt_nos) {
                sharedViewModel.fala(requireContext(),"Nome do nosso time alterado para ${novoNome.toString()}.")
                ...
                sharedViewModel.fala(requireContext(),"Nome do time adversário alterado para ${novoNome.toString()}.")
